...
class EquidistantDistorter:
    def __init__(self, k1: float, k2: float, k3: float, k4: float):
        """ set the camera calibration parameters k1-4 from the equidistant distortion model for wide-angle lenses. Seems to be the Kannala-Brandt distortion model implemented in Kalibr.
        
        args
        ----
        - `k1`: distortion model parameter
        - `k2`: distortion model parameter
        - `k3`: distortion model parameter
        - `k4`: distortion model parameter
        """
    ...
    def distort(self, point: tuple):
        """ [P normalized image plane] ==> [P distorted image plane]. Apply equidistant distortion to a 2D point in the normalized image plane.
    ...
    def undistort(self, point: tuple, iterations: int=20):
        """ [P distorted image plane] ==> [P normalized image plane]. Remove equidistant distortion from a 2D point in the distorted image plane.
